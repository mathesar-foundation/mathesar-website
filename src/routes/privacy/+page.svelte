...
<div class="bg-stormy-50 flex-grow">
  ...
  >
    ...
    <p class="italic">
      For the self-hosted version of Mathesar, please see the first section of this Privacy Policy. For all other Mathesar websites, services, and interactions, please see the remainder of the policy starting with the section entitled “Scope of this Privacy Policy.”
    </p>
    ...
    <h2 id="self-hosted-installations">Self-Hosted Installations</h2>
    <p>Mathesar is committed to respecting your privacy. This privacy policy explains the data collected when you opt-in to send anonymized analytics data and how that information is used.</p>
    <h3 id="self-hosted-what-data">What Data Do We Collect?</h3>

    <p>If you opt to enable analytics collection, Mathesar Foundation gathers anonymized usage data to improve the tool. This includes:</p>
    <ul>
        <li>Information about your installation (e.g., a unique installation ID, Mathesar version).</li>
        <li>General usage statistics (e.g., the number of user accounts, databases, and records).</li>
        <li>Activity metrics (e.g., counts of active users and features used).</li>
    </ul>
    <p>No personally identifiable information (PII) is collected or transmitted.</p>

    <h3 id="self-hosted-why-collect">Why Do We Collect This Data?</h3>
    <p>We collect this data to:</p>
    <ul>
        <li>Understand how Mathesar is being used.</li>
        <li>Identify areas to improve the user experience.</li>
        <li>Track adoption and ensure the reliability of the tool..</li>
    </ul>

    <h3 id="self-hosted-how-data-protected">How Do We Protect Your Data?</h3>
    <p> We take your privacy seriously. Here’s how we safeguard your information:</p>
    <ul>
        <li>Anonymization: We do not collect or send personally identifiable information (PII).</li>
        <li>Restricted Access: Analytics data is only accessible to our team for product improvement purposes.</li>
    </ul>
   
    <h3 id="self-hosted-how-data-used">How Is the Data Used?</h3>
    <p> The collected data is used solely for:</p>
    <ul>
        <li>Improving Mathesar's features, performance, and stability.</li>
        <li>Generating aggregate statistics (e.g., total installations).</li>
    </ul>
   <p>We do not share, sell, or disclose this data to third parties.</p>
        
   <h3 id="self-hosted-opt-out">Opt-Out Option</h3>
   <p>Analytics collection is entirely optional. You can choose not to enable it during installation or turn it off at any time through the settings or configuration file.</p>

    <h3 id="self-hosted-updates">Updates to This Policy</h3>
    <p>We may update this privacy policy as needed. Please review it periodically.</p>
    
    <h2 id="scope">Scope of this Privacy Policy</h2>
    <p>The remainder of this Privacy Policy applies to: Visitors to mathesar.org, Mathesar documentation, code repositories, and other Mathesar websites (collectively, the “Sites”)</p>
    ...
    <ul>
      ...
      <li>
        <strong>Application</strong> refers to Mathesar, the software program provided
        by the Company.
      </li>
      <li>
      ...
      <li>
        ...
        "Us" or "Our" in this Agreement) refers to Center of Complex
        Interventions, Inc., 15 Walnut St, Suite 150, Wellesley, MA 02481.<br />
      ...
      <li>
        <strong>Do Not Track</strong> (DNT) is a concept that has been promoted by
      ...
      <li>
        ...
        mental, economic, cultural or social identity.<br />
      ...
      <li><strong>Sites</strong> means Visitors to mathesar.org, Mathesar documentation, code repositories, and other Mathesar websites
      </li>
      <li>
      ...
      <li>
        <strong>Website</strong> refers to Mathesar, accessible from
        <a href="https://mathesar.org/">https://mathesar.org/</a>
      </li>
      <li>
    ...
    <p>
      Usage Data is collected automatically via Simple Analytics. This allows us
      to improve our website and create a better experience for our visitors. We
      do not track or profile visitors and we do not serve personalized
      advertising. We do not share this data with anyone.
    </p>
    ...
    <ul>
      ...
      <li>
        ...
        for example, to count users who have visited those pages or opened an email
        and for other related website statistics (for example, recording the popularity
    ...
    <h5 id="necessary--essential-cookies">Necessary / Essential Cookies</h5>
    ...
    <h5 id="functionality-cookies">Functionality Cookies</h5>
    ...
    <h2 id="detailed-information-on-the-processing-of-your-personal-data">
    ...
    <h2 id="gdpr-privacy">GDPR Privacy</h2>
    ...
    <ul>
      ...
      <li>
        <strong>Public interests:</strong> Processing Personal Data is related to
        a task that is carried out in the public interest or in the exercise of official
    ...
    <h2 id="ccpa-privacy">CCPA Privacy</h2>
    ...
    <h4 id="category-a-identifiers">Category A: Identifiers</h4>
    ...
    <h4
      id="category-b-personal-information-categories-listed-in-the-california-customer-records-statute-cal-civ-code--179880e"
    >
    ...
    <h4
      id="category-c-protected-classification-characteristics-under-california-or-federal-law"
    >
    ...
    <h4 id="category-d-commercial-information">
    ...
    <h4 id="category-e-biometric-information">
    ...
    <h4 id="category-f-internet-or-other-similar-network-activity">
    ...
    <h4 id="category-g-geolocation-data">Category G: Geolocation data</h4>

    <p>Examples: Approximate physical location.</p>

    <p>Collected: No.</p>

    <h4 id="category-h-sensory-data">Category H: Sensory data</h4>
    ...
    <h4 id="category-i-professional-or-employment-related-information">
    ...
    <h4
      id="category-j-non-public-education-information-per-the-family-educational-rights-and-privacy-act-20-usc-section-1232g-34-cfr-part-99"
    >
    ...
    <h4 id="category-k-inferences-drawn-from-other-personal-information">
    ...
    <h3 id="sale-of-personal-information">Sale of Personal Information</h3>
    ...
    <h3 id="share-of-personal-information">Share of Personal Information</h3>
    ...
    <h3 id="sale-of-personal-information-of-minors-under-16-years-of-age">
    ...
    <h2 id="your-california-privacy-rights-californias-shine-the-light-law">
